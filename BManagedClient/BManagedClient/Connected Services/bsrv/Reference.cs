// ----------------------------------------------------------------------------
// Hand-written equivalent of svcutil-generated Reference.cs.
// Lets BManagedClient compile without running "Add Service Reference" in VS.
//
// Endpoint config comes from BManagedClient/App.config:
//     <client><endpoint name="BasicHttpBinding_IService1" .../></client>
// ----------------------------------------------------------------------------
...
namespace BManagedClient.bsrv
{
    // ============================ DATACONTRACTS =============================
    // Namespace MUST match the server's default ("http://schemas.datacontract.org/2004/07/Model")
    // so SOAP serialization matches.
